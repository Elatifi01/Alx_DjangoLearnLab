...
urlpatterns = [
    ...
    path("post/<int:pk>/update/", PostUpdateView.as_view(), name='post-update-alt'),  # Update post (alternative URL)
    ...
    path('tags/<slug:tag_slug>/', PostByTagListView.as_view(), name='posts-by-tag'),  # Posts by tag (slug version)
]
